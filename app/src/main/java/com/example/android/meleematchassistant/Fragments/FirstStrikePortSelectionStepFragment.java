...
public class FirstStrikePortSelectionStepFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainViewModel.isRPSStepCompleted().observe(getActivity(), new Observer<Boolean>() {
            ...
            public void onChanged(@Nullable Boolean stepCompleted) {
                ...
                TextView instructionsTextView = rootView.findViewById(R.id.first_strike_port_selection_step_instructions_text_view);
    ...
    public String createInstructions() {
        String rPSWinner = playersDatabase.getPlayerStringFromId(playersDatabase.getRPSWinnerId());
        String rPSLoser = playersDatabase.getPlayerStringFromId(playersDatabase.getRPSLoserId());
        return rPSWinner + " " + getString(R.string.first_strike_port_selection_step_instructions_rps_winner) + "." +
                "\n" + rPSLoser + " " + getString(R.string.first_strike_port_selection_step_instructions_rps_loser);
    }
}